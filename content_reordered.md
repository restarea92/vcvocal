...
- **🔗 논리적 흐름 제어/구조화**
    - 모든 정보는 우선순위에 따라 배치되어야 합니다. 단, 이 때 우선순위의 주체는 "방문자"입니다.
...
> [!TIP]
> - 구체적인 사례를 머릿속으로 그려볼 수 있도록 구성하는 것이 좋습니다.
> - 커리큘럼을 학교 과목의 목차처럼 구성하는 것이 아니라, 어떻게 시작해야 할 지, 진행중에 어떻게 즐거움을 느끼고 목표를 위해 나아갈 수 있을 지, 그리고 어떤 변화가 기대되는지를 읽는 사람이 스스로 상상해 볼 수 있도록 하는 문장들로 구성하고 각 단계를 객관적 설명보다는 구체적인 행동 중심으로 설명하는 것이 좋습니다.
